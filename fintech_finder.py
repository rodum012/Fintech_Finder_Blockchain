...
################################################################################
# 3. Imports the following functions from the `crypto_wallet.py` file:
# * `generate_account`
# * `get_balance`
# * `send_transaction`
...
##########################################
#  Calls the `generate_account` function and save it as the variable `account`
...
# Writes the inTech Finder candidate's hourly rate to the sidebar
...
# variable named `transaction_hash`, and has it displayed on the application’s
# web interface.


if st.sidebar.button("Send Transaction"):

    # Calls the `send_transaction` function and passes it 3 parameters:
